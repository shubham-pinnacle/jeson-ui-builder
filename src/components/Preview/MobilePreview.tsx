...
const MobilePreview: React.FC<MobilePreviewProps> = ({
  ...
  const footerComponent = components.find(
    (comp) => comp.type === "footer-button"
  );
  const nonFooterComponents = components.filter(
    (comp) => comp.type !== "footer-button"
  );
    ...
    switch (component.type) {
        ...
        return (
          <StyledFormControl key={component.id}>
            ...
            >
              ...
              {getOptions(component.properties?.options).map(
                (option: string) => (
      ...
      case 'opt-in':
        ...
        return (
          <FormControlLabel
            key={component.id}
            control={
              <Checkbox required={component.properties?.required === "true"} />
            }
      ...
      case 'DocumentPicker':
        ...
        return (
          <StyledFormControl key={component.id}>
            <FormLabel>
              {component.properties?.label || "Upload File"}
            </FormLabel>
            <input
              type="file"
